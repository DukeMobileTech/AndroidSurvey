...
@android.arch.persistence.room.Entity(tableName = "ConditionSkips",
...
public class ConditionSkip implements Entity {
    @PrimaryKey
    @NonNull
    @SerializedName("id")

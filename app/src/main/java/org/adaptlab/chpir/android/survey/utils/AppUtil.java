...
import org.adaptlab.chpir.android.survey.repositories.CollageRepository;
...
import org.adaptlab.chpir.android.survey.repositories.DiagramRepository;
...
import org.adaptlab.chpir.android.survey.repositories.OptionCollageRepository;
...
import org.adaptlab.chpir.android.survey.repositories.QuestionCollageRepository;
...
import org.adaptlab.chpir.android.survey.repositories.TaskRepository;
...
public class AppUtil {
    ...
    public static List<EntityDownloadTask> downloadData() {
        ...
        tasks.add(new CollageRepository(application).download());
        tasks.add(new DiagramRepository(application).download());
        tasks.add(new QuestionCollageRepository(application).download());
        tasks.add(new OptionCollageRepository(application).download());
        tasks.add(new TaskRepository(application).download());

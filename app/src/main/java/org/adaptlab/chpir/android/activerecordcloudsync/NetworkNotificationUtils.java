...
public class NetworkNotificationUtils {
    ...
    public static boolean checkForNetworkErrors(Context context) {
        if (!isNetworkAvailable(context.getApplicationContext())) {
            ...
            showNotification(context, android.R.drawable.ic_dialog_alert, R.string
                    .network_unavailable);
            ...
            Log.i(TAG, "Android version code is not acceptable, short circuiting PollService...");
            showNotification(context, android.R.drawable.ic_dialog_alert, R.string
                    .unacceptable_version_code);
        } else {
            return true;
        }

...
public class LocationServiceManager {
    ...
    public static final String ACTION_LOCATION =
            "org.adaptlab.chpir.android.survey.Location.LocationReceiver.ACTION_LOCATION";
    ...
    public void startLocationUpdates() {
        if (ContextCompat.checkSelfPermission(mAppContext, android.Manifest.permission
